...
var Truncatable = require('./truncatable');
var Pandigital = require('./pandigital');
...
Value.prototype.ciclicPermutations = function() {
  ...
  while(isDifferent) {
    ...
    current = currentDigits.splice(1);
...
Value.prototype.isPermutation = function(n) {
  ...
  Profile.count('Value_isPermutation');
  ...
  if (N.length !== M.length) {
    Profile.count('Value_isPermutation_lmismatch');
    return false;
  }
